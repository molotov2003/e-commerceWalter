...
function isVoidTag(tag) {
  var _tag$;
  return voidMap.has(tag.toLowerCase()) && ((_tag$ = tag[0]) === null || _tag$ === void 0 ? void 0 : _tag$.toLowerCase()) === tag[0];
}
class Printer {
  constructor(options) {
...
class Matcher {
  constructor() {
    _defineProperty(this, "_whens", new When());
  }
  /**
...
class CharPositionSpan {
  constructor(source, charPositions) {
    _defineProperty(this, "kind", OffsetKind.CharPosition);
...
const eql = match(m => m.when(OffsetKind.HbsPosition, OffsetKind.HbsPosition, (_ref, _ref2) => {
  ...
  return left === ((_right$toCharPos = right.toCharPos()) === null || _right$toCharPos === void 0 ? void 0 : _right$toCharPos.offset);
}).when(OffsetKind.HbsPosition, OffsetKind.CharPosition, (left, _ref6) => {
  var _left$toCharPos;
  let {
    offset: right
  } = _ref6;
  return ((_left$toCharPos = left.toCharPos()) === null || _left$toCharPos === void 0 ? void 0 : _left$toCharPos.offset) === right;
...
class Source {
  static from(source) {
    var _options$meta;
    let options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    return new Source(source, (_options$meta = options.meta) === null || _options$meta === void 0 ? void 0 : _options$meta.moduleName);
  }
  constructor(source) {
...
function isUpperCase(tag) {
  var _tag$, _tag$2;
  return tag[0] === ((_tag$ = tag[0]) === null || _tag$ === void 0 ? void 0 : _tag$.toUpperCase()) && tag[0] !== ((_tag$2 = tag[0]) === null || _tag$2 === void 0 ? void 0 : _tag$2.toLowerCase());
}
function isLowerCase(tag) {
  var _tag$3, _tag$4;
  return tag[0] === ((_tag$3 = tag[0]) === null || _tag$3 === void 0 ? void 0 : _tag$3.toLowerCase()) && tag[0] !== ((_tag$4 = tag[0]) === null || _tag$4 === void 0 ? void 0 : _tag$4.toUpperCase());
}
...
class PathExpressionImplV1 {
  constructor(original, head, tail, loc) {
    ...
    _defineProperty(this, "this", false);
    _defineProperty(this, "data", false);
    // Cache for the head value.
    _defineProperty(this, "_head", undefined);
...
class Parser {
  constructor(source) {
    let entityParser = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new simpleHtmlTokenizer.EntityParser(simpleHtmlTokenizer.HTML5NamedCharRefs);
...
function preprocess(input) {
  ...
  if (typeof input === 'string') {
    var _options$meta;
    source = new Source(input, (_options$meta = options.meta) === null || _options$meta === void 0 ? void 0 : _options$meta.moduleName);
    if (mode === 'codemod') {
    ...
    var _options$meta2;
    source = new Source('', (_options$meta2 = options.meta) === null || _options$meta2 === void 0 ? void 0 : _options$meta2.moduleName);
    ast = input;
  }
...
function getTemplateLocals(html) {
  ...
  if (!(options !== null && options !== void 0 && options.includeKeywords)) {
...
var _hasDebugger = /*#__PURE__*/new WeakMap();
class ProgramSymbolTable extends SymbolTable {
  constructor(templateLocals, options) {
    super();
    _defineProperty(this, "symbols", []);
    _defineProperty(this, "upvars", []);
    _defineProperty(this, "size", 1);
    _defineProperty(this, "named", util.dict());
    _defineProperty(this, "blocks", util.dict());
    _defineProperty(this, "usedTemplateLocals", []);
    _classPrivateFieldInitSpec(this, _hasDebugger, {
      writable: true,
      value: false
    });
  ...
  setHasDebugger() {
    _classPrivateFieldSet(this, _hasDebugger, true);
  }
  get hasEval() {
    return _classPrivateFieldGet(this, _hasDebugger);
  }
  has(name) {
...
class BlockSymbolTable extends SymbolTable {
  ...
  get(name) {
    let local = _classPrivateMethodGet(this, _get, _get2).call(this, name);
...
class Children {
  constructor(loc, children, block) {
    _defineProperty(this, "namedBlocks", void 0);
    _defineProperty(this, "hasSemanticContent", void 0);
    _defineProperty(this, "nonBlockChildren", void 0);
    this.loc = loc;
