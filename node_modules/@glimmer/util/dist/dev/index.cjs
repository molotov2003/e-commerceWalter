...
function isSimpleElement(node) {
  return (node === null || node === void 0 ? void 0 : node.nodeType) === ELEMENT_NODE;
}
function isElement(node) {
  return (node === null || node === void 0 ? void 0 : node.nodeType) === ELEMENT_NODE && node instanceof Element;
}
function checkBrowserNode(node, check) {
  ...
  if (isMatch && node instanceof Node) {
    ...
    throw checkError(`SimpleElement(${(node === null || node === void 0 ? void 0 : (_node$constructor = node.constructor) === null || _node$constructor === void 0 ? void 0 : _node$constructor.name) ?? 'null'})`, check);
  }
}
