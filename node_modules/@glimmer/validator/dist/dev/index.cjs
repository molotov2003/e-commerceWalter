...
class MonomorphicTagImpl {
  ...
  constructor(type) {
    _defineProperty(this, "revision", INITIAL);
    _defineProperty(this, "lastChecked", INITIAL);
    _defineProperty(this, "lastValue", INITIAL);
    _defineProperty(this, "isUpdating", false);
...
class VolatileTag {
  constructor() {
    _defineProperty(this, TYPE, VOLATILE_TAG_ID);
  }
  [COMPUTE]() {
    return VOLATILE;
  }
...
class CurrentTag {
  constructor() {
    _defineProperty(this, TYPE, CURRENT_TAG_ID);
  }
  [COMPUTE]() {
    return $REVISION;
  }
