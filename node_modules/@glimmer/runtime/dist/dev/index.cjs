...
class NewElementBuilder {
  ...
  constructor(env, parentNode, nextSibling) {
    ...
    _defineProperty(this, CURSOR_STACK, new util.Stack());
    _defineProperty(this, "modifierStack", new util.Stack());
    _defineProperty(this, "blockStack", new util.Stack());
...
class AppendOpcodes {
  constructor() {
    _defineProperty(this, "evaluateOpcode", util.fillNulls(vm.Op.Size).slice());
  }
  add(name, evaluate) {
...
APPEND_OPCODES.add(vm.Op.Dup, (vm, _ref4) => {
  let {
    op1: register,
    op2: offset
  } = _ref4;
...
APPEND_OPCODES.add(vm.Op.Pop, (vm, _ref5) => {
  let {
    op1: count
  } = _ref5;
  vm.stack.pop(count);
});
APPEND_OPCODES.add(vm.Op.Load, (vm, _ref6) => {
  let {
    op1: register
  } = _ref6;
  vm.load(register);
});
APPEND_OPCODES.add(vm.Op.Fetch, (vm, _ref7) => {
  let {
    op1: register
  } = _ref7;
  vm.fetch(register);
});
APPEND_OPCODES.add(vm.Op.BindDynamicScope, (vm, _ref8) => {
  let {
    op1: _names
  } = _ref8;
...
APPEND_OPCODES.add(vm.Op.Enter, (vm, _ref9) => {
  let {
    op1: args
  } = _ref9;
  vm.enter(args);
...
APPEND_OPCODES.add(vm.Op.PushSymbolTable, (vm, _ref10) => {
  let {
    op1: _table
  } = _ref10;
  let stack = vm.stack;
...
APPEND_OPCODES.add(vm.Op.JumpIf, (vm, _ref11) => {
  let {
    op1: target
  } = _ref11;
...
APPEND_OPCODES.add(vm.Op.JumpUnless, (vm, _ref12) => {
  let {
    op1: target
  } = _ref12;
  let reference$1 = debug.check(vm.stack.pop(), CheckReference);
...
APPEND_OPCODES.add(vm.Op.JumpEq, (vm, _ref13) => {
  let {
    op1: target,
    op2: comparison
  } = _ref13;
...
class JumpIfNotModifiedOpcode {
  constructor() {
    _defineProperty(this, "tag", validator.CONSTANT_TAG);
...
APPEND_OPCODES.add(vm.Op.Text, (vm, _ref) => {
  let {
    op1: text
  } = _ref;
  vm.elements().appendText(vm[CONSTANTS].getValue(text));
});
APPEND_OPCODES.add(vm.Op.Comment, (vm, _ref2) => {
  let {
    op1: text
  } = _ref2;
  vm.elements().appendComment(vm[CONSTANTS].getValue(text));
});
APPEND_OPCODES.add(vm.Op.OpenElement, (vm, _ref3) => {
  let {
    op1: tag
  } = _ref3;
...
APPEND_OPCODES.add(vm.Op.Modifier, (vm$1, _ref4) => {
  let {
    op1: handle
  } = _ref4;
...
APPEND_OPCODES.add(vm.Op.DynamicModifier, vm$1 => {
  ...
  let instanceRef = reference.createComputeRef(() => {
    ...
    let definition = constants.getValue(util.expect(handle, 'BUG: modifier handle expected'));
    let {
      manager
    } = definition;
    let state = manager.create(owner, util.expect(constructing, 'BUG: ElementModifier could not find the element it applies to'), definition.state, args);
    return {
      manager,
      state,
      definition
...
APPEND_OPCODES.add(vm.Op.StaticAttr, (vm, _ref5) => {
  let {
    op1: _name,
    op2: _value,
    op3: _namespace
...
APPEND_OPCODES.add(vm.Op.DynamicAttr, (vm, _ref6) => {
  let {
    op1: _name,
    op2: _trusting,
    op3: _namespace
...
APPEND_OPCODES.add(vm.Op.PushComponentDefinition, (vm, _ref) => {
  let {
    op1: handle
  } = _ref;
...
APPEND_OPCODES.add(vm.Op.ResolveDynamicComponent, (vm$1, _ref2) => {
  let {
    op1: _isStrict
  } = _ref2;
...
APPEND_OPCODES.add(vm.Op.PushArgs, (vm, _ref3) => {
  let {
    op1: _names,
    op2: _blockNames,
    op3: flags
...
APPEND_OPCODES.add(vm.Op.PrepareArgs, (vm$1, _ref4) => {
  let {
    op1: _state
  } = _ref4;
  let stack = vm$1.stack;
...
APPEND_OPCODES.add(vm.Op.CreateComponent, (vm$1, _ref5) => {
  let {
    op1: flags,
    op2: _state
  } = _ref5;
...
APPEND_OPCODES.add(vm.Op.RegisterComponentDestructor, (vm$1, _ref6) => {
  let {
    op1: _state
  } = _ref6;
  let {
...
APPEND_OPCODES.add(vm.Op.BeginComponentTransaction, (vm, _ref7) => {
  let {
    op1: _state
  } = _ref7;
  let name;
...
APPEND_OPCODES.add(vm.Op.ComponentAttr, (vm$1, _ref8) => {
  let {
    op1: _name,
    op2: _trusting,
    op3: _namespace
...
APPEND_OPCODES.add(vm.Op.StaticComponentAttr, (vm$1, _ref9) => {
  let {
    op1: _name,
    op2: _value,
    op3: _namespace
...
class ComponentElementOperations {
  constructor() {
    _defineProperty(this, "attributes", util.dict());
...
APPEND_OPCODES.add(vm.Op.DidCreateElement, (vm$1, _ref10) => {
  let {
    op1: _state
  } = _ref10;
  let {
...
APPEND_OPCODES.add(vm.Op.GetComponentSelf, (vm$1, _ref11) => {
  let {
    op1: _state,
    op2: _names
  } = _ref11;
    ...
    if (hasCustomDebugRenderTreeLifecycle(manager$1)) {
      ...
      nodes.forEach(node => {
        ...
        destroyable.registerDestructor(instance, () => {
          ...
          (_vm$env$debugRenderTr = vm$1.env.debugRenderTree) === null || _vm$env$debugRenderTr === void 0 ? void 0 : _vm$env$debugRenderTr.willDestroy(bucket);
        });
      ...
      destroyable.registerDestructor(instance, () => {
        ...
        (_vm$env$debugRenderTr2 = vm$1.env.debugRenderTree) === null || _vm$env$debugRenderTr2 === void 0 ? void 0 : _vm$env$debugRenderTr2.willDestroy(instance);
      });
...
APPEND_OPCODES.add(vm.Op.GetComponentTagName, (vm, _ref12) => {
  let {
    op1: _state
  } = _ref12;
  let {
...
APPEND_OPCODES.add(vm.Op.GetComponentLayout, (vm$1, _ref13) => {
  let {
    op1: _state
  } = _ref13;
  let instance = debug.check(vm$1.fetchValue(_state), CheckComponentInstance);
...
APPEND_OPCODES.add(vm.Op.Main, (vm, _ref14) => {
  let {
    op1: register
  } = _ref14;
...
APPEND_OPCODES.add(vm.Op.PopulateLayout, (vm, _ref15) => {
  let {
    op1: _state
  } = _ref15;
  let {
...
APPEND_OPCODES.add(vm.Op.VirtualRootScope, (vm$1, _ref16) => {
  let {
    op1: _state
  } = _ref16;
  let {
...
APPEND_OPCODES.add(vm.Op.SetupForEval, (vm, _ref17) => {
  let {
    op1: _state
  } = _ref17;
...
APPEND_OPCODES.add(vm.Op.SetNamedVariables, (vm, _ref18) => {
  let {
    op1: _state
  } = _ref18;
  let state = debug.check(vm.fetchValue(_state), CheckFinishedComponentInstance);
...
APPEND_OPCODES.add(vm.Op.SetBlocks, (vm, _ref19) => {
  let {
    op1: _state
  } = _ref19;
  let state = debug.check(vm.fetchValue(_state), CheckFinishedComponentInstance);
...
// Dynamic Invocation Only
APPEND_OPCODES.add(vm.Op.InvokeComponentLayout, (vm, _ref20) => {
  let {
    op1: _state
  } = _ref20;
  let state = debug.check(vm.fetchValue(_state), CheckFinishedComponentInstance);
...
APPEND_OPCODES.add(vm.Op.DidRenderLayout, (vm$1, _ref21) => {
  let {
    op1: _state
  } = _ref21;
  let instance = debug.check(vm$1.fetchValue(_state), CheckComponentInstance);
...
class DebugRenderTreeUpdateOpcode {
  ...
  evaluate(vm) {
    ...
    (_vm$env$debugRenderTr3 = vm.env.debugRenderTree) === null || _vm$env$debugRenderTr3 === void 0 ? void 0 : _vm$env$debugRenderTr3.update(this.bucket);
  }
}
class DebugRenderTreeDidRenderOpcode {
  ...
  evaluate(vm) {
    ...
    (_vm$env$debugRenderTr4 = vm.env.debugRenderTree) === null || _vm$env$debugRenderTr4 === void 0 ? void 0 : _vm$env$debugRenderTr4.didRender(this.bucket, this.bounds);
  }
}
...
class VMArgumentsImpl {
  constructor() {
    ...
    _defineProperty(this, "positional", new PositionalArgumentsImpl());
    _defineProperty(this, "named", new NamedArgumentsImpl());
    _defineProperty(this, "blocks", new BlockArgumentsImpl());
  }
  empty(stack) {
...
class NamedArgumentsImpl {
  constructor() {
    ...
    _defineProperty(this, "length", 0);
    _defineProperty(this, "_references", null);
    _defineProperty(this, "_names", util.EMPTY_STRING_ARRAY);
    _defineProperty(this, "_atNames", util.EMPTY_STRING_ARRAY);
  }
  empty(stack, base) {
    this.stack = stack;
    this.base = base;
...
class BlockArgumentsImpl {
  constructor() {
    ...
    _defineProperty(this, "names", util.EMPTY_STRING_ARRAY);
    _defineProperty(this, "length", 0);
    _defineProperty(this, "base", 0);
  }
  empty(stack, base) {
...
function createConcatRef(partsRefs) {
  return reference.createComputeRef(() => {
    let parts = new Array();
    for (const [i, ref] of util.enumerate(partsRefs)) {
      let value = reference.valueForRef(ref);
      if (value !== null && value !== undefined) {
...
APPEND_OPCODES.add(vm.Op.Curry, (vm$1, _ref) => {
  let {
    op1: type,
    op2: _isStrict
  } = _ref;
...
APPEND_OPCODES.add(vm.Op.DynamicHelper, vm$1 => {
  ...
  let helperInstanceRef = reference.createComputeRef(() => {
    ...
    if (isCurriedType(definition, vm.CurriedTypes.Helper)) {
      ...
      let helper = resolveHelper(vm$1[CONSTANTS], resolvedDef, ref);
      if (named !== undefined) {
        args.named = util.assign({}, ...named, args.named);
      }
      if (positional !== undefined) {
      ...
      let helper = resolveHelper(vm$1[CONSTANTS], definition, ref);
...
APPEND_OPCODES.add(vm.Op.Helper, (vm$1, _ref2) => {
  let {
    op1: handle
  } = _ref2;
  let stack = vm$1.stack;
...
APPEND_OPCODES.add(vm.Op.GetVariable, (vm, _ref3) => {
  let {
    op1: symbol
  } = _ref3;
...
APPEND_OPCODES.add(vm.Op.SetVariable, (vm, _ref4) => {
  let {
    op1: symbol
  } = _ref4;
...
APPEND_OPCODES.add(vm.Op.SetBlock, (vm, _ref5) => {
  let {
    op1: symbol
  } = _ref5;
...
APPEND_OPCODES.add(vm.Op.ResolveMaybeLocal, (vm, _ref6) => {
  let {
    op1: _name
  } = _ref6;
  let name = vm[CONSTANTS].getValue(_name);
...
APPEND_OPCODES.add(vm.Op.RootScope, (vm, _ref7) => {
  let {
    op1: symbols
  } = _ref7;
  vm.pushRootScope(symbols, vm.getOwner());
});
APPEND_OPCODES.add(vm.Op.GetProperty, (vm, _ref8) => {
  let {
    op1: _key
  } = _ref8;
...
APPEND_OPCODES.add(vm.Op.GetBlock, (vm, _ref9) => {
  let {
    op1: _block
  } = _ref9;
  let {
...
APPEND_OPCODES.add(vm.Op.Concat, (vm, _ref10) => {
  let {
    op1: count
  } = _ref10;
...
class ScopeInspector {
  constructor(scope, symbols, debugInfo) {
    _defineProperty(this, "locals", util.dict());
    this.scope = scope;
...
APPEND_OPCODES.add(vm.Op.Debugger, (vm, _ref) => {
  let {
    op1: _symbols,
    op2: _debugInfo
  } = _ref;
...
APPEND_OPCODES.add(vm.Op.EnterList, (vm, _ref) => {
  let {
    op1: relativeStart,
    op2: elseTarget
  } = _ref;
...
APPEND_OPCODES.add(vm.Op.Iterate, (vm, _ref2) => {
  let {
    op1: breaks
  } = _ref2;
  let stack = vm.stack;
...
class DebugRenderTreeImpl {
  constructor() {
    _defineProperty(this, "stack", new util.Stack());
...
class EnvironmentImpl {
  constructor(options, delegate) {
    _defineProperty(this, TRANSACTION, null);
    _defineProperty(this, "updateOperations", void 0);
  ...
  begin() {
    ...
    (_this$debugRenderTree = this.debugRenderTree) === null || _this$debugRenderTree === void 0 ? void 0 : _this$debugRenderTree.begin();
  ...
  commit() {
    ...
    transaction.commit();
    (_this$debugRenderTree2 = this.debugRenderTree) === null || _this$debugRenderTree2 === void 0 ? void 0 : _this$debugRenderTree2.commit();
...
class OnModifierState {
  constructor(element, args) {
    _defineProperty(this, "tag", validator.createUpdatableTag());
    _defineProperty(this, "element", void 0);
    _defineProperty(this, "args", void 0);
    _defineProperty(this, "once", void 0);
    _defineProperty(this, "passive", void 0);
  ...
  updateFromArgs() {
    ...
    let needsCustomCallback = SUPPORTS_EVENT_OPTIONS === false && once /* needs manual once implementation */ || env.DEBUG && passive; /* needs passive enforcement */
...
class OnModifierManager {
  constructor() {
    _defineProperty(this, "SUPPORTS_EVENT_OPTIONS", SUPPORTS_EVENT_OPTIONS);
  }
  getDebugName() {
    return 'on';
  }
...
class UpdatingVM {
  constructor(env, _ref) {
    ...
    _defineProperty(this, "frameStack", new util.Stack());
    this.env = env;
    this.dom = env.getDOM();
...
class ListItemOpcode extends TryOpcode {
  constructor(state, runtime, bounds, key, memo, value) {
    ...
    _defineProperty(this, "retained", false);
...
class EvaluationStackImpl {
  ...
  dup() {
    let position = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this[REGISTERS][vm.$sp];
  ...
  get(offset) {
    let base = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this[REGISTERS][vm.$fp];
    return this.stack[base + offset];
  }
  set(value, offset) {
    let base = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this[REGISTERS][vm.$fp];
...
class Stacks {
  constructor() {
    _defineProperty(this, "scope", new util.Stack());
    _defineProperty(this, "dynamicScope", new util.Stack());
    _defineProperty(this, "updating", new util.Stack());
    _defineProperty(this, "cache", new util.Stack());
    _defineProperty(this, "list", new util.Stack());
  }
}
class VM {
  get stack() {
  ...
  constructor(runtime, _ref, elementStack, context) {
    ...
    _defineProperty(this, STACKS, new Stacks());
    _defineProperty(this, HEAP, void 0);
    _defineProperty(this, "destructor", void 0);
    _defineProperty(this, DESTROYABLE_STACK, new util.Stack());
    _defineProperty(this, CONSTANTS, void 0);
    _defineProperty(this, ARGS$1, void 0);
    _defineProperty(this, INNER_VM, void 0);
  ...
  captureState(args) {
    let pc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this[INNER_VM].fetchRegister(vm.$pc);
    return {
      pc,
      scope: this.scope(),
...
class RehydratingCursor extends CursorImpl {
  constructor(element, nextSibling, startingBlockDepth) {
    ...
    _defineProperty(this, "injectedOmittedNode", false);
