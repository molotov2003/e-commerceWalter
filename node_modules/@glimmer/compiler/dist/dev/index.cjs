...
class ProgramSymbols {
  constructor() {
    _defineProperty(this, "_freeVariables", []);
    _defineProperty(this, "_symbols", ['this']);
    _defineProperty(this, "top", this);
  }
  toSymbols() {
...
class Keywords {
  constructor(type) {
    _defineProperty(this, "_keywords", []);
...
function assertIfUnlessInlineKeyword(type) {
  return originalNode => {
    ...
    if (positional.size > 3) {
      return Err(syntax.generateSyntaxError(`When used inline, (${type}) can receive a maximum of three positional parameters 1. the condition that determines the state of the (${type}), 2. the value to return if the condition is ${inverted ? 'false' : 'true'}, and 3. the value to return if the condition is ${inverted ? 'true' : 'false'}. Received ${(positional === null || positional === void 0 ? void 0 : positional.size) ?? 0} parameters`, originalNode.loc));
    }
    return Ok({
      condition,
      truthy,
...
class ClassifiedComponent {
  constructor(tag, element) {
    _defineProperty(this, "dynamicFeatures", true);
    this.tag = tag;
    this.element = element;
  }
  arg(attr, _ref) {
...
class NormalizationState {
  constructor(block, isStrict) {
    _defineProperty(this, "_currentScope", void 0);
    _defineProperty(this, "_cursorCount", 0);
...
class WireFormatDebugger {
  constructor(_ref) {
    ...
    _defineProperty(this, "upvars", void 0);
...
function precompileJSON(string) {
  ...
  const source = new syntax.src.Source(string ?? '', (_options$meta = options.meta) === null || _options$meta === void 0 ? void 0 : _options$meta.moduleName);
...
function precompile(source) {
  ...
  const moduleName = (_options$meta2 = options.meta) === null || _options$meta2 === void 0 ? void 0 : _options$meta2.moduleName;
