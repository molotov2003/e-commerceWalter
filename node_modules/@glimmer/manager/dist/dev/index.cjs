  ...
  getHelper(definition) {
    return (capturedArgs, owner) => {
      ...
      if (hasValue(manager)) {
        ...
        var _manager$getDebugName;
        let ref = reference.createConstRef(undefined, env.DEBUG && (((_manager$getDebugName = manager.getDebugName) === null || _manager$getDebugName === void 0 ? void 0 : _manager$getDebugName.call(manager, definition)) ?? 'unknown helper'));
...
class FunctionHelperManager {
  constructor() {
    _defineProperty(this, "capabilities", buildCapabilities({
      hasValue: true,
